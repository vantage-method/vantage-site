...
(function() {
    ...
    document.querySelectorAll('.blaise-about, .blaise-brings, .blaise-helps, .blaise-focus').forEach(section => {
    ...
    document.querySelectorAll('.blaise-brings, .blaise-focus, .blaise-helps').forEach(section => {
...
/* ============================================
   ...
   ============================================ */
(function () {
    var form = document.getElementById('blaise-lead-form');
    if (!form) return;

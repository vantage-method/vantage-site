...
(function() {
    ...
    document.querySelectorAll('.randy-about, .randy-brings, .randy-helps, .randy-focus').forEach(section => {
    ...
    document.querySelectorAll('.randy-brings, .randy-focus, .randy-helps').forEach(section => {
...
/* ============================================
   ...
   ============================================ */
(function () {
    var form = document.getElementById('randy-lead-form');
    if (!form) return;

...
(function() {
    ...
    document.querySelectorAll('.zach-about, .zach-brings, .zach-helps, .zach-focus').forEach(section => {
    ...
    document.querySelectorAll('.zach-brings, .zach-focus, .zach-helps').forEach(section => {
